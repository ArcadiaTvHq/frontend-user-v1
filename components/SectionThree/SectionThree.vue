<template>
  <section class="text-textprimary font-orbitron flex flex-col items-center mt-16 overflow-x-hidden trigger">
...
<style>
  ...
  .cardbtngold:hover{
    animation: cardbtnhovergold 0.5s linear forwards;
  }

  @keyframes cardbtnhovergold{
    to{
      transform: scale(1.05);
